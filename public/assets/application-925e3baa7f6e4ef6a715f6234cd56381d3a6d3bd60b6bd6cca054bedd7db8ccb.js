...
jQuery(document).ready(function($){
	...
	var marker_url = ( is_internetExplorer11 ) ? 'img/barber/cd-icon-location.png' : 'img/barber/cd-icon-location.svg';
